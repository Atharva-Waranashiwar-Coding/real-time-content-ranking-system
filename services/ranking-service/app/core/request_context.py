"""Request context helpers for ranking-service."""
...
class RequestContext:
    """Request-scoped identifiers used for logging and ranking decision events."""
    ...
    def to_log_fields(self) -> dict[str, str | None]:
        """Return structured log fields for this request."""
...
def build_request_context(request: Request) -> RequestContext:
    """Build request context from headers and request metadata."""
...
def get_request_context(request: Request) -> RequestContext:
    """Dependency returning the current request context."""
