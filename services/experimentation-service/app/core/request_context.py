"""Request context helpers for experimentation-service."""
...
class RequestContext:
    """Request-scoped identifiers used for logging and persistence."""
...
def build_request_context(request: Request) -> RequestContext:
    """Build request context from inbound headers and request metadata."""
